...
class XETrainer(BaseTrainer):
    ...
    def eval(self, data):
        # data.batches 中记录了这个batch有哪些 sentences
        print("the num of batches in valid data:", len(data))
        total_loss = 0
        total_words = 0
...
#            del checkpoint
            ...
            batch_order = None
            iteration = 0
            print('Initializing model parameters') # but currently nothing is done here
